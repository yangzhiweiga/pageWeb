		...
		<!-- Header -->
			<header id="header" class="alt">
				<h1 id="logo"><a href="index.tpl.php">Twenty <span>by HTML5 UP</span></a></h1>
				<nav id="nav">
					<ul>
						<li class="current"><a href="index.tpl.php">Welcome</a></li>
						<li class="submenu">
							<a href="">Layouts</a>
							<ul>
		...
		<!-- Main -->
			<article id="main">
				...
				<header class="special container">
					...
					released for free under the <a href="#/license">Creative Commons Attribution 3.0</a> license. Have fun!</p>
				</header>
